...
export const V4_MCP_INPUT_SCHEMAS = Object.freeze({
  ...
  'broker.submit_verdict': z.object({ run_id: runId, packet_hash: hash, verdict: z.enum(['APPROVED', 'REJECTED']), reason: z.string().min(1).max(4_000) }).strict(),
});
...
export const brokerReviewPacketSchemaV4 = z.object({
