...
const unique = <T extends z.ZodTypeAny>(schema: T, max: number, min = 0) =>
  z
    .array(schema)
    .min(min)
    .max(max)
...
export interface CapabilityMatchV4 {
  readonly compatible: true;
  readonly contract_hash: string;
  readonly capability_hash: string;
  readonly match_hash: string;
}
...
export function createModelCapabilityContractV4(input: z.input<typeof contractBody>): ModelCapabilityContractV4 {
  ...
  return Object.freeze({
    ...body,
    reasoning_efforts: Object.freeze([...body.reasoning_efforts]),
    contract_hash: hashCanonicalV4(body),
  }) as unknown as ModelCapabilityContractV4;
}
...
export function createModelAdapterCapabilitiesV4(input: z.input<typeof adapterBody>): ModelAdapterCapabilitiesV4 {
  ...
  return Object.freeze({
    ...body,
    tool_protocols: Object.freeze([...body.tool_protocols]),
    filesystems: Object.freeze([...body.filesystems]),
    networks: Object.freeze([...body.networks]),
    context_modes: Object.freeze([...body.context_modes]),
    reasoning_efforts: Object.freeze([...body.reasoning_efforts]),
    capability_hash: hashCanonicalV4(body),
  }) as unknown as ModelAdapterCapabilitiesV4;
}
...
export function matchModelCapabilitiesV4(contractInput: unknown, adapterInput: unknown): CapabilityMatchV4 {
  ...
  const compatible =
    (!contract.structured_output || adapter.structured_output) &&
  ...
  return Object.freeze({
    ...
    capability_hash: adapter.capability_hash,
    match_hash: hashCanonicalV4({ contract_hash: contract.contract_hash, capability_hash: adapter.capability_hash }),
  });
}
