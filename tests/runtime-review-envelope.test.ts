...
function fullContract(): any { const h = hash('a'); const body = { schema_version: 4, task_id: 'TASK-1', request_id: 'req_01HZX3YH8C7Y9QJ4J6M2G5K8N1', run_id: 'run_01HZX3YH8C7Y9QJ4J6M2G5K8N1', repository_id: 'fixture', repository_root_hash: h, base_sha: 'b'.repeat(40), objective: 'Review change', task_class: 'change', requested_risk_class: 'normal', effective_risk_class: 'normal', requested_route: 'AUTO', effective_route: 'ECONOMY', route_decision_reasons: ['eligible'], route_decision_hash: h, effective_data_scope: 'SOURCE_CODE_ONLY', effective_source_sensitivity: 'PUBLIC', allowed_changes: [{ path: 'src/x.ts', operations: ['MODIFY'] }], acceptance_tests: ['tests/x.test.ts'], implementation_targets: [{ path: 'src/x.ts', operations: ['MODIFY'] }], allowed_validation_ids: ['test'], inputs: [], constraints: [], success_criteria: ['passes'], max_files_changed: 1, max_changed_lines: 20, max_attempts: 3, sandbox_profile_hashes: { review: h }, prohibited_actions: ['push'], result_schema_version: 4, policy_hash: h, profile_hash: h }; return { ...body, contract_hash: hashCanonicalV4(body) }; }
