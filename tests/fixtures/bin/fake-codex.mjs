...
process.stdout.write(`${JSON.stringify({ type: 'item.completed', item: { id: 'item_1', type: 'agent_message', text: JSON.stringify({ schema_version: 4, status: 'COMPLETED', summary: 'Implemented the bounded change.', changed_paths: ['src/greeting.ts'] }) } })}\n`);
