...
| `0.3.x` macOS     | V4 schema `4`                                           | Portable framework behavior is exercised on Node 24; separate host, filesystem and coordinator evidence required   | Requalify the exact macOS combination                               | No automatic production qualification implied                                      |
